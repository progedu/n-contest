  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <h2 className='ribbon ribbon_result'>
          <img src='/suica.png' />
          結果発表
        </h2>
        ...
        <div className='award_box'>
          ...
          <h4 className='award first'>
            <span className='lw'></span>
            <span className='lh'></span>
            <span className='rw'></span>
            <span className='rh'></span>最優秀賞
          </h4>
          <AwardContentCard
            title='1分間タイピングゲーム'
            author='ミニミニコ'
          ...
          />
          <h4 className='award second'>
            <span className='lw'></span>
            <span className='lh'></span>
            <span className='rw'></span>
            <span className='rh'></span>アイデア賞
          </h4>
          <AwardContentCard
            title='おみくじ'
            author='shiro'
          ...
          <h4 className='award second'>
            ...
            <span className='lh'></span>
            <span className='rw'></span>
            <span className='rh'></span>デザイン特別賞
          </h4>
          <AwardContentCard
            title='iroin'
            author='sada'
        ...
        <h2 className='ribbon ribbon_contest'>
